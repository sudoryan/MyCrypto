...
export enum NameServiceActions {
  RESOLVE_DOMAIN_REQUESTED = 'NAME_SERVICES_RESOLVE_DOMAIN_REQUESTED',
  RESOLVE_DOMAIN_SUCCEEDED = 'NAME_SERVICES_RESOLVE_DOMAIN_SUCCEEDED',
  RESOLVE_DOMAIN_FAILED = 'NAME_SERVICES_RESOLVE_DOMAIN_FAILED',
  RESOLVE_DOMAIN_CACHED = 'NAME_SERVICES_RESOLVE_DOMAIN_CACHED'
}
